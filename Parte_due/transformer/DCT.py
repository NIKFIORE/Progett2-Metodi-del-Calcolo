...
class DCT2Transformer:
    ...
    def validate_implementation(self):
        ...
        # Test di ciclo completo: DCT2 + IDCT2
        reconstructed = self.idct2_fast(dct2_scipy)
        print("\nRicostruzione DCT2 → IDCT2 (prime due righe):")
        print(reconstructed[0, :])
        print(reconstructed[1, :])
        print("\nDifferenza media tra originale e ricostruito:")
        print(np.mean(np.abs(test_block - reconstructed)))